...
SQUEEZELLM_FISHER_BATCH_SIZE="${SQUEEZELLM_FISHER_BATCH_SIZE:-1}"
SQUEEZELLM_FISHER_ACCUM_DEVICE="${SQUEEZELLM_FISHER_ACCUM_DEVICE:-gpu}"
SQUEEZELLM_FISHER_GRAD_CHECKPOINTING="${SQUEEZELLM_FISHER_GRAD_CHECKPOINTING:-1}"
...
export SQUEEZELLM_FISHER_BATCH_SIZE SQUEEZELLM_FISHER_ACCUM_DEVICE SQUEEZELLM_FISHER_GRAD_CHECKPOINTING SQUEEZELLM_FISHER_LAYERS_PER_PASS
...

{
  ...
  echo "SqueezeLLM Fisher accum: $SQUEEZELLM_FISHER_ACCUM_DEVICE, grad_checkpointing=$SQUEEZELLM_FISHER_GRAD_CHECKPOINTING, layers_per_pass=$SQUEEZELLM_FISHER_LAYERS_PER_PASS, batch_size=$SQUEEZELLM_FISHER_BATCH_SIZE"

...
export SQUEEZELLM_FISHER_ACCUM_DEVICE SQUEEZELLM_FISHER_GRAD_CHECKPOINTING
...

{
  ...
  echo "SqueezeLLM Fisher accum: $SQUEEZELLM_FISHER_ACCUM_DEVICE, grad_checkpointing=$SQUEEZELLM_FISHER_GRAD_CHECKPOINTING"
